...
// ============ PAGE CODE ============
// LINK BABA - Analytics page logic
initMotion();
...
function renderStats() {
  ...
  animateCounter(document.getElementById('statVisitors'), uniqueIps.size || Math.round(totalClicks * 0.8));
  animateCounter(document.getElementById('statCountries'), countries.size || Math.min(totalClicks, 1));
