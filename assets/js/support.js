...
// ============ PAGE CODE ============
// LINK BABA - Support page logic (FAQ accordion + contact form)
initMotion();
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Yes! Free users can create custom aliases for their links. Pick a memorable name like "linkbaba.online/myspecialdeal" instead of a random code. Custom aliases must be unique across the platform.'
  },
  {
